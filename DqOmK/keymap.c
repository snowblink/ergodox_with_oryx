...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    MT(MOD_LCTL, KC_ESCAPE),KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           LT(2, KC_SCLN), KC_QUOTE,
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_MAC_PASTE,                                   LGUI(KC_KP_MINUS), KC_N,           KC_M,           KC_COMMA,       KC_DOT,         MT(MOD_RCTL, KC_SLASH),KC_RIGHT_SHIFT,
    TT(4),          CW_TOGG,        KC_LEFT_CTRL,   KC_LEFT_ALT,    KC_LEFT_GUI,                                                                                                    KC_LEFT_GUI,    KC_LEFT_ALT,    KC_LEFT_CTRL,   KC_TRANSPARENT, TT(3),
                                                                                                    KC_MINUS,       KC_EQUAL,       KC_LBRC,        KC_RBRC,
                                                                                                                    KC_HOME,        KC_DELETE,
                                                                                    KC_LEFT_GUI,    KC_ENTER,       KC_END,         KC_TRANSPARENT, KC_BSPC,        KC_SPACE
  ),
